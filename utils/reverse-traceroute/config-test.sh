...
export OUTDIR=$CDIR/utils/reverse-traceroute/results/revtr-jc-test
...
export APIPORT=8082
export APILOGDIR=/home/cunha/revtr_jc_test/
...
export REVTR_WAIT_TIME=$((1*60))  # RevTr (last batch included synchronously)

export REVTR_LABEL=revtr_jc_test
